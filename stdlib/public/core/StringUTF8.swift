...
extension String.UTF8View.Index {
  ...
  public init?(_ utf16Index: String.UTF16Index, within utf8: String.UTF8View) {
    if _fastPath(utf8._core.isASCII) {
      self = utf16Index
      return
    }
    if utf16Index == utf8.startIndex || utf16Index == utf8.endIndex {
      self = utf16Index
      return
    }
    ...
    if _slowPath(
      UTF16.isTrailSurrogate(utf16[utf16Index])
      && UTF16.isLeadSurrogate(utf16[utf16.index(before: utf16Index)])) {
      return nil
    }
    self = utf8._index(atEncodedOffset: utf16Index.encodedOffset)
  }
}
