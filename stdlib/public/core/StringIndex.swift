...
extension String.Index {
  internal init(encodedOffset o: Int, _ c: _Cache = .utf16) {
  ...
  public var encodedOffset : Int {
    return Int(_compoundOffset >> numericCast(_strideBits))
  }
}

// Legacy position translation
extension String.Index {
  public func samePosition<T>(in _: T) -> String.Index { return self }
}
