...
// PRIVATE_NOMINAL_MEMBERS_7-DAG: Decl[InstanceMethod]/Super:         elementsEqual({#(other): _Sequence#}, {#by: (Int, _Sequence.Element) throws -> Bool##(Int, _Sequence.Element) throws -> Bool#})[' rethrows'][#Bool#]; name=elementsEqual(other: _Sequence, by: (Int, _Sequence.Element) throws -> Bool) rethrows
// PRIVATE_NOMINAL_MEMBERS_7-DAG: Decl[InstanceMethod]/Super:         elementsEqual({#(other): _Sequence#})[#Bool#]; name=elementsEqual(other: _Sequence)
