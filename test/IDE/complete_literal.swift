...
// LITERAL4-DAG:     Decl[InstanceMethod]/CurrNominal:   append({#contentsOf: _Sequence#})[#Void#]; name=append(contentsOf: _Sequence){{$}}
...
// LITERAL5-DAG:     Decl[InstanceMethod]/CurrNominal/NotRecommended/TypeRelation[Invalid]: append({#contentsOf: _Sequence#})[#Void#]{{; name=.+$}}
