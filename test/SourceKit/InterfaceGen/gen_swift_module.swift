...
// SYNTHESIZED-USR1: s:s17MutableCollectionPss012RandomAccessB0Rzs10Comparable7Elements9_SequencePRpzrlE4sortyyF::SYNTHESIZED::s:Sa

// RUN: %sourcekitd-test -req=interface-gen-open -module Swift -synthesized-extension \
// RUN: 	== -req=find-usr -usr "s:s17MutableCollectionPss012RandomAccessB0Rzs10Comparable7Elements9_SequencePRpzrlE4sortyyF::SYNTHESIZED::s:Sa" | %FileCheck -check-prefix=SYNTHESIZED-USR2 %s
// SYNTHESIZED-USR2-NOT: USR NOT FOUND

// RUN: %sourcekitd-test -req=interface-gen-open -module Swift \
// RUN: 	== -req=find-usr -usr "s:s17MutableCollectionPss012RandomAccessB0Rzs10Comparable7Elements9_SequencePRpzrlE4sortyyF::SYNTHESIZED::s:Sa::SYNTHESIZED::USRDOESNOTEXIST" | %FileCheck -check-prefix=SYNTHESIZED-USR3 %s
